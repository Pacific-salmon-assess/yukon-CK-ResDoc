...
These should be clearly mixed, with no single distribution deviating substantially from others (left column), and no chains exploring a strange space for a few iterations (right column)."Dir_alpha" refers to Dirichlet shape parameter for the gamma distribution used to generate vector of age-at-maturity proportions.
