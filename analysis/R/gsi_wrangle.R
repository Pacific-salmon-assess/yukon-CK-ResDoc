...
write.csv(long.gsi,"analysis/data/raw/border-gsi-table-2024-update.csv")
...
# border passage and GSI samples -----
bc <- border_passage %>%
  drop_na(count) %>%
...
png(here("csasdown/figure/gsi-run-samples.PNG"), width = 6, height = 8, units = "in", res = 600)
print(g)
dev.off()
