...
Total run size indices were assumed to arise from a lognormal distribution with standard deviation $\tau_y$, which was equal to the product of the externally estimated CV (INSERT PARAMETER) and the index (Table Xb 13-14).
