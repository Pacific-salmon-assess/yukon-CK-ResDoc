...
Total run size indices were assumed to arise from a lognormal distribution with standard deviation τ_y, which was equal to the product of the externally estimated CV (0.06) and the index (T4.13-T4.14).
