...
(ref:fig-run-RR-fits) Total border passage estimates based on the run-reconstruction model (grey circles with bars indicating the central 95% confidence interval), mark-recapture based estimates of run size from fish sampled from fishwheels after accounting for selectivity (open square), annual sum of daily fishwheel counts (scaled by estimated catchability, open green triangle) and the Eagle sonar (open red circle).
