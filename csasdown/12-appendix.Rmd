...
table.in |>   
   ...
   dplyr::mutate_all(function(x){gsub("\\\\n","\n", x)}) |>
#   mutate_all(function(x){gsub("\\\\#","\#", x)}) |>
   csasdown::csas_table(format = "latex", escape = FALSE, font_size = 10,align = c("l","l"),
                  caption = "(ref:TabVariables)") |>
