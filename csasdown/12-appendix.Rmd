...
(ref:fig-CU-harv-compare) CU group composition of Chinook salmon sampled in commercial and subsistence fisheries in Alaska ("Harvest") and fish sampled in test fisheries at the Alaska-Yukon Territory border ("Border").  
```{r fig-CU-harv-compare, fig.cap = "(ref:fig-CU-harv-comparee)"}
