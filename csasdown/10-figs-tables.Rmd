...
bench.pars <- bench.pars |> 
  dplyr::mutate_at(3:6, function(x){round(x/1000, 2)}) |>
...
(ref:demo-ref-pts) Population (conservation unit) reference points from demographic (egg mass) models. Values are in thousands of fish. ! CHECK if these are 50th percentiles or other quantity!!
...
demo.pars <- demo.pars |> 
  ...
  dplyr::mutate(`Median (50$^{\\text{th}}$ percentile)` = paste0(median, " (", lower, ",", upper, ")"))
...
demo.pars |> 
  ...
  csasdown::csas_table(format = "latex",
                     ...
                     align = "llc") |>
  kableExtra::collapse_rows(columns=1, latex_hline = "major") |>
  kableExtra::collapse_rows(columns=3, latex_hline = "major")
