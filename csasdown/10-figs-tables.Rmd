...
(ref:fig-map-assess) Sites of major assessment projects for adult Canadian-origin Yukon Chinook that may inform in-season management decisions. Full list of assessment projects is in Table \@ref(tab:assess-proponents).
...
assess_tbl |> 
  ...
  kableExtra::column_spec(2, width = "2cm") |>
  kableExtra::column_spec(3, width = "4cm") |>
  kableExtra::footnote(general=c("*Assessment projects which provide in-season fisheries data on Chinook salmon returns to Canadian Yukon River and tributaries"))
```
\clearpage
