...
(ref:fig-map-assess) Sites of major assessment projects for adult Canadian-origin Yukon Chinook that may inform in-season management decisions. A full list of assessment projects is in Table \@ref(tab:assess-proponents).
...
(ref:demo-ref-pts) conservation Unit reference points from demographic (egg mass) models. Values are in thousands of fish.
