...
(ref:OM-scenarios) Alternative productivity ($alpha$) scenarios tested in forward simulations. Values are the posterior medians of ($alpha$) estimated by time-varying productivity models across three time frames: the most recent Chinook salmon generation (brood years 2013--2018), the long term average (1985--2018), and the most recent fully observed single brood year (2017).
...
(ref:pars-ref-pts) Estimates of biological reference points by Conservation Unit, based on parameters from spawner-recruitment models. Values are in thousands of fish (except $U_{MSY}$).
