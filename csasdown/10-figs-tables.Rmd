...
(ref:fig-map-assess) Major assessment projects for adult Chinook salmon Canadian portion of the Yukon River watershed. A full list of assessment projects is provided in Table \@ref(tab:assess-proponents).
...
(ref:fig-run-timing) Average annual daily passage (scaled to maximum) from Alaska into the Yukon Territory for each Conservation Unit. For reference, in a non-leap year the 180th, 210th and 240th day of the year correspond to 29 June, 29 July, and 28 August, respectively. The dashed line represents the approximate average peak run-timing for the stock aggregate.
...
\clearpage
\begin{landscapepage}
(ref:tab-ref-perf-measures) Consequences of alternative Harvest Control Rules based on range of biological and fishery performance measures (Table \@ref(tab:tab-perf-metrics-descriptions)) under the reference (base case) productivity operating model scenario. LSR and USR refer to lower and upper reference points, respectively.
...
\clearpage
(ref:tab-rob-perf-measures) Consequences of alternative Harvest Control Rules based on range of biological and fishery performance measures (Table \@ref(tab:tab-perf-metrics-descriptions)) under the robustness (worst case) productivity operating model scenario.LSR and USR refer to lower and upper reference points, respectively.
