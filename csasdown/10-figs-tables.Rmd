...
(ref:tab-cons-unit-smu) The Stock Management Units and Conservation Units that make up the Yukon Chinook major fish stock prescribed under the Fish Stock Provisions of Canada's *Fisheries Act*. The average annual contribution of each Conservation Unit to the Yukon Chinook salmon Stock Management Unit based on genetics is also shown. 
...
\clearpage
\begin{landscapepage}
(ref:assess-proponents) Assessment projects that which provide in-season fisheries data on Chinook salmon returns to Canadian Yukon River and tributaries. 
