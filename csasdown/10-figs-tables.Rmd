...
knitr::include_graphics(here::here("csasdown/figure/sim-schematic.pdf"))
```
...
(ref:fig-demo-smsr) Egg mass vs spawner based ref points by CU.
...
(ref:fig-projections) Projections.

```{r fig-projections, fig.cap = "(ref:fig-projections)"}
knitr::include_graphics(here::here("analysis/plots/S-fwd_simple_grp_TVA.png"))
```
