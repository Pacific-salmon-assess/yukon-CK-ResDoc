...
Under a "no fishing" scenario, median spawner abundances were projected to exceed CU specific lower reference points for all CUs by 2050, and two CUs were projected to exceed their upper reference points over the same time period: Big Salmon and Upper Yukon River. An additional CU, Middle Yukon River and tribs., had a 50% quantile interval that overlapped with its upper reference point (Figure \@ref(fig:fig-projections)).
