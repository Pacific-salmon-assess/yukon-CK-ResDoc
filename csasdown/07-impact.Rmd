...
Under a "no fishing" scenario, median spawner abundances were projected to exceed CU specific lower reference points for all CUs by 2050, and two CUs were projected to exceed their upper reference points over the same time period: Middle Yukon and tribs., Nordenskiold, and Yukon R. Teslin Headwaters \@ref(fig:fig-perf-ref).
