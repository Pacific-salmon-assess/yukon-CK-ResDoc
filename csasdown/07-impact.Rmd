...
Under a "no fishing" scenario, median spawner abundances were projected to exceed CU specific lower reference points for all CUs by 2050, and three CUs were projected to meet or exceed their upper reference points over the same time period: Middle Yukon River and tributaries, Big Salmon, and Upper Yukon River (Figure \@ref(fig:fig-projections)).
...
The current moratorium on fishing (at run-sizes below 71,000) was projected to allow for some population growth and hence modest opportunities for harvest (Figure \@ref(fig:fig-projections)). Specifically, annual harvest rates averaged 15%, and harvest was projected to be \~10,000 fish on average per year, though this was highly variable from year to year and only 30% of years were expected to result in First Nations Basic Needs Allocation being met (Figure \@ref(fig:fig-perf-ref); Table \@ref(tab:tab-ref-perf-measures)). Under this scenario median spawner abundances were projected to exceed CU specific lower reference points for all CUs, and the Upper Yukon River CU was projected to exceed its upper reference point. Placing a maximum harvest rate cap on this harvest control rule reduced average annual harvest rates and harvest slightly but otherwise had little impact on the biological performance measures.
